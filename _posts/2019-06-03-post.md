...
In this lesson we should prepare date for final mapping and mapping we are doing in `QGIS`.

This homework should be done in followin steps:
 1) Collecting all toponyms
 2) Reformating Getty Geographical Thesaurus (from XML)
